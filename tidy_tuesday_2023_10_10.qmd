...
filters:
  - social-share
share:
  permalink: "https://aditya-dahiya.github.io/session_presentations/projects.html"
...
@fig-word-clouds-by-gender illustrates the prevalence of gender-specific common words in haunted locations, comparing all American locations to haunted spots in universities and colleges.
...
In contrast to the previous slide's word clouds featuring overlapping terms, the @fig-unique-words-to-each-gender shows distinct vocabulary found exclusively in male and female haunted locations.
