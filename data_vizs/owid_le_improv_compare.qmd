...
annotationdf <-  tibble(
  ...
  finding = c(
    "Disportionately highest rise in life expectancy at birth (compared to beyond 65) driven by control of childhood infections and vaccinations.",
    ...
    "More countries start to improve life expectancy beyond 65 years, and by much more.",
    "Global trend of enhanced elderly care, with more dots above 45-degree line, most of them of richer countries.")
)
...
ggsave(
  filename = here::here("data_vizs", "owid_le_improv_compare.png"),
  plot = g_base,
  height = 297 * 2,
  width = 210 * 2,
  units = "mm",
