...
![The same data with a boxplot. So indeed, we dont see any noticeable increase in temperatures - no discernable movement of boxplots to the right.](dip_temp_heatmap_boxplot.png)
...
![Boxplot of monthly temperature ranges, with a overlaid smoother line, from 1950 to 2023.](dip_temp_heatmap_boxplot2.png)
