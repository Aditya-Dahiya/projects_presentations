...
selected_measures <- normalized_data |> 
...
measure_labels <- c(
  ...
  "Breeding Ewes 2 Tooth and Over put to Ram"         = "Breeding Ewes",
  "Maize (yield)"                                     = "Maize Yield",
  "Number of Farm Holdings"                           = "Farm Holdings",
  "Oats (yield)"                                      = "Oats Yield",
  "Rising 1 Year Old Dairy Heifers and Heifer Calves" = "Dairy Heifers",
  "Total Area of Farms"                               = "Farm Area",
  "Total Lambs Marked and/or Tailed"                  = "Lambs Marked",
...
g <- df1 |> 
  ...
  ggrepel::geom_text_repel(
    data = df1 |> group_by(measure) |> slice_max(year, n = 1),
    mapping = aes(
      x = 2024, 
      label = measure,
      colour = measure
