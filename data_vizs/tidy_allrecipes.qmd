...
# Add text to plot-------------------------------------------------
plot_title <- "tidy_allrecipes"

plot_subtitle <- "tidy_allrecipes" |> str_wrap(105)
...
plot_data |> 
  ...
  coord_radial(
    theta = "y",
    inner.radius = 0,  # Smaller inner radius for better visibility
    expand = FALSE
  ) +
  ...
  labs(
    title = "Nutritional Composition by Cuisine",
    subtitle = "Countries ordered by carbohydrate proportion (highest to lowest)\nPie size reflects average calories per recipe"
  )
