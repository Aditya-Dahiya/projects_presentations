---
title: "Insights from H1B-visas dataset"
...
plotdf <- df4 |> 
  ...
  mutate(
    cluster = case_when(
      ...
      ((total > 1000) & (perc_multiple < 0.5)) ~ "B",
...
plot_title <- "Gaming the H1B Lottery System" 
...
g <- plotdf |> 
  ...
  labs(
    ...
    size = "Number of applicants Sponsored by the firm"
  ) +
  theme_minimal(
