...
date: "2024-08-21"
subtitle: "Visualoizing the ages of English Monarchs at the time of marriages"
categories:
  - "#TidyTuesday"
...
![.........................](tidy_english_monarchs.png){#fig-1}
  ...
  mutate(
    king_age = case_when(
      (king_age == consort_age) & 
        (king_gender == "Male") ~ king_age + 1,
      (king_age == consort_age) & 
        (king_gender == "Female") ~ king_age - 1,
      .default = king_age
    ),
    consort_age = case_when(
      (consort_age == king_age) & 
        (consort_gender == "Male") ~ consort_age + 1,
      (consort_age == king_age) & 
        (consort_gender == "Female") ~ consort_age - 1,
      .default = consort_age
    )
  )
```
