...
# Background Colour
mypal <- c("#188a8d", "#def3f6", "white", "grey10", "#f77919")
orange_palette <- paletteer::paletteer_c("grDevices::Oranges", n = 30)[8:17]
...
inset1 <- busiest_airports |> 
  ...
  geom_col(fill = mypal[5], alpha = 0.8) +
  geom_richtext(
    aes(
      x = 0,
