...
# Add text to plot-------------------------------------------------
plot_title <- "A Git-Hub style Habits tracking chart\n(2025) !"

plot_subtitle <- str_wrap("2025 was transformative! Atomic Habits (read in June 2024) and Can’t Hurt Me (read in Oct 2024) helped me focus on my daily habits over the entire year.", 70)
```
...
df1 <- checkmarks1 |>
  ...
  mutate(
    activity = case_when(
      activity == "walk" ~ "Minutes spent walking each day",
      activity == "exercise" ~ "Minutes spent on kids' studies",
