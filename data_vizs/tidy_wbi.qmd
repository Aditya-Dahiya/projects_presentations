...
g_base <- plotdf |> 
  ...
  annotate(
    ...
    x = 0.24, y = 1.5,
    hjust = 0, vjust = 1,
    label = str_wrap("Countries in the light-orange rectangle pay their nurses less than clerks, but doctors more than clerks.", 90),
    lineheight = 0.25,
    angle = 90,
    size = 24, 
    family = "body_font",
