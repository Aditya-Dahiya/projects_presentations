...
# Colour for the text
text_col <- bg_col |> darken(0.9) 

# Colour for highlighted text
text_hil <- bg_col |> darken(0.7)
...
plot_subtitle <- glue::glue("Of the top 30 albums at both platforms (2003-2020), some albums are <b style='color:{label_cols[1]}'>more popular</b> on <br> Billboard (stayed in Billboard Top 200 rankings for more weeks), while <b style='color:{label_cols[2]}'>others</b> enjoy higher <br> popularity on Spotify. Others are equally popular on both.<br>
