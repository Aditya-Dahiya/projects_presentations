...
g_base <- plotdf1 |>  
  ...
  theme(
    ...
    plot.subtitle = element_text(
      ...
      size = bts,
      colour = text_hil,
      margin = margin(100,0,5,0, "mm")
    ),
    plot.caption = element_textbox(
      family = "caption_font",
      colour = text_hil,
      hjust = 0.5,
      margin = margin(200,0,0,0, "mm")
    ),
