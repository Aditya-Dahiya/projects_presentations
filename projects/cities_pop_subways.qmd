---
title: "Public Transport and Population Density in select cities"
...
Get administrative boundaries of the 5 select cities: London, Tokyo, New York City, Mumbai, and Delhi
...
![](images/cities_pop_subway_1.png)
...
![](images/cities_pop_subway_2.png)
...
g <- ggplot() +
  ...
  labs(
    title = "Delhi: Population Density vs. Subway Stops",
    caption = plot_caption
  ) +
  theme(
    legend.position = "inside",
...
![](images/cities_pop_subway_3.png)
