...
mypal <- paletteer::scale_colour_paletteer_d("nbapalettes::nuggets_city2")
...
plotdf |> 
  ...
  annotate(
    geom = "text",
    label = "Line of 100% rise -- population doubled in the decade",
    x = 7,
    y = 1.02,
    family = "caption_font",
    colour = text_hil,
  ...
  annotate(
    geom = "text",
    label = "Line of 200% rise -- population tripled in the decade",
    x = 7,
    y = 2.02,
    family = "caption_font",
    colour = text_hil,
...
# Now plan a hex plot like ggbeeswarm
```
