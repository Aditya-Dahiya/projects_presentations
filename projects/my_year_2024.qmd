...
plot_subtitle <- str_wrap("During this year 2024, I read the books Atomic HAbits (around June) and Can't Hurt Me (Around Oct-November), which helped me shape my routine daily habits. Here is an outcome chart for my year 2024.", 80)
```
...
plot_custom <- function(
  ...
  temp_df <- checkmarks |> 
    ...
    theme(
      ...
      # All margins
      plot.margin = margin(10,0,5,0, "mm"),
