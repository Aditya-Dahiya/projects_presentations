...
A static graph can only show so few risk factor to avoid overcrowding. Lets look at an interactive graph now using `ggplotly()` [@plotly] to display all the risk factors: --
...
### Other visualization methods: Datawrapper

Another better interactive visualization with higlighting feature across ailments using [*datawrapper.de*](https://app.datawrapper.de/) . However, I am unable to add [tool-tips](https://academy.datawrapper.de/article/116-how-to-create-useful-tooltips-for-your-maps) to this interactive visualization: --
...
### Removing the effect of age to see other risk factors
